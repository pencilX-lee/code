...
from model.metrics import compute_mIoU, show_results
import glob
import numpy as np
import torch
import os
...
def cal_miou(test_dir="D:/project/Test_Images",
             pred_dir="D:/project/results", gt_dir="D:/project/Test_Labels"):
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        net.load_state_dict(torch.load('best_1.pth', map_location=device)) # todo
        net.eval()
    ...
    if miou_mode == 0 or miou_mode == 2:
        ...
        print("Get miou done.")
        miou_out_path = "D:/project/results"
